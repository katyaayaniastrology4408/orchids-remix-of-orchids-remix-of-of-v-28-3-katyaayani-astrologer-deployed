...
<div style="max-width:600px;margin:0 auto;background:linear-gradient(160deg,#0a0612 0%,#120820 50%,#0a0612 100%);">
  ...
  <div style="position:relative;overflow:hidden;">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;background:linear-gradient(transparent,rgba(10,6,18,0.95));padding:24px 28px 20px;">
      <span style="background:#f97316;color:#fff;font-size:11px;font-weight:700;letter-spacing:1px;padding:4px 12px;border-radius:4px;text-transform:uppercase;">🌑 ખગોળ • Jyotish</span>
    </div>
  </div>
  ...
  <div style="padding:32px 32px 24px;">
    ...
    <div style="background:rgba(249,115,22,0.08);border:1px solid rgba(249,115,22,0.25);border-radius:12px;padding:20px 24px;margin:0 0 24px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="padding:6px 0;color:#d1d5db;font-size:14px;">🌑 ગ્રહણ ક્યારે &amp; ક્યાં?</td>
          <td style="padding:6px 0;color:#f97316;font-size:14px;font-weight:600;text-align:right;">2026</td>
        </tr>
        <tr><td colspan="2" style="border-top:1px solid rgba(255,255,255,0.06);"></td></tr>
        <tr>
          <td style="padding:6px 0;color:#d1d5db;font-size:14px;">🕐 સૂતક &amp; ગ્રહણ-કાળ</td>
          <td style="padding:6px 0;color:#f97316;font-size:14px;font-weight:600;text-align:right;">9 કલાક</td>
        </tr>
        <tr><td colspan="2" style="border-top:1px solid rgba(255,255,255,0.06);"></td></tr>
        <tr>
          <td style="padding:6px 0;color:#d1d5db;font-size:14px;">🪬 12 રાશિ ફળ &amp; ઉપાય</td>
          <td style="padding:6px 0;color:#10b981;font-size:14px;font-weight:600;text-align:right;">✓ Included</td>
        </tr>
        <tr><td colspan="2" style="border-top:1px solid rgba(255,255,255,0.06);"></td></tr>
        <tr>
          <td style="padding:6px 0;color:#d1d5db;font-size:14px;">📿 ખાસ ઉપાય</td>
          <td style="padding:6px 0;color:#10b981;font-size:14px;font-weight:600;text-align:right;">✓ Included</td>
        </tr>
      </table>
    </div>
    ...
    <div style="text-align:center;margin:0 0 28px;">
      <a href="${blogUrl}" style="display:inline-block;background:linear-gradient(135deg,#f97316,#dc2626);color:#fff;font-size:16px;font-weight:700;text-decoration:none;padding:16px 36px;border-radius:50px;letter-spacing:0.5px;box-shadow:0 4px 20px rgba(249,115,22,0.4);">
    ...
    <div style="background:rgba(0,0,0,0.4);border-top:1px solid rgba(249,115,22,0.2);padding:24px 32px;text-align:center;">
      ...
      <p style="margin:0 0 10px;font-size:12px;color:#6b7280;font-style:italic;">"ગ્રહ બદલો, ભાગ્ય બદલો"</p>
      <p style="margin:0 0 6px;font-size:11px;color:#4b5563;">
        <a href="https://wa.me/919824929588" style="color:#9ca3af;text-decoration:none;">📞 +91 98249 29588</a>
        &nbsp;|&nbsp;
        <a href="mailto:katyaayaniastrologer01@gmail.com" style="color:#9ca3af;text-decoration:none;">✉️ katyaayaniastrologer01@gmail.com</a>
      </p>
      <p style="margin:0 0 12px;font-size:11px;color:#4b5563;">
        <a href="https://www.katyaayaniastrologer.com" style="color:#9ca3af;text-decoration:none;">🌐 www.katyaayaniastrologer.com</a>
        &nbsp;|&nbsp;
        <a href="https://www.instagram.com/katyaayani_astrologer" style="color:#9ca3af;text-decoration:none;">📸 @katyaayani_astrologer</a>
      </p>
...
async function getAllEmails() {
  ...
  (subs || []).forEach(s => {
    if (s.email && !emailMap.has(s.email.toLowerCase())) {
      emailMap.set(s.email.toLowerCase(), {
        email: s.email,
  ...
  (profiles || []).forEach(p => {
    if (p.email && !emailMap.has(p.email.toLowerCase())) {
      emailMap.set(p.email.toLowerCase(), { email: p.email, name: p.name || '' });
    }
  });
...
const sendAt = new Date(Date.now() + DELAY_MS);
console.log(`\n⏰ Email scheduled for: ${sendAt.toLocaleTimeString('gu-IN', { hour: '2-digit', minute: '2-digit' })} (1 hour from now)`);
console.log(`📬 Will send Chandra Grahan blog email to all subscribers...`);
console.log(`⏳ Waiting...`);
