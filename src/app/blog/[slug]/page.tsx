            ...
            <div className="lg:sticky lg:top-28 flex flex-col gap-6">
              ...
              <div className={`rounded-2xl border p-5 flex flex-col gap-4 ${theme === 'dark' ? 'bg-[#12121a] border-[#ff6b35]/20' : 'bg-[#fffdf9] border-[#ff6b35]/20'}`}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-wider opacity-50 font-bold">
                      {language === 'gu' ? 'લેખક' : language === 'hi' ? 'लेखक' : 'Author'}
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-wider opacity-50 font-bold">
                      {language === 'gu' ? 'પ્રકાશિત' : language === 'hi' ? 'प्रकाशित' : 'Published'}
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-wider opacity-50 font-bold">
                      {language === 'gu' ? 'વ્યૂ' : language === 'hi' ? 'व्यू' : 'Views'}
                    </p>
                ...
                {post.tags && post.tags.length > 0 && (
                  <div>
                    <p className="text-[10px] uppercase tracking-wider opacity-50 font-bold mb-2">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {post.tags.map((tag) => (
                        <Link
                          ...
                          className={`px-3 py-0.5 rounded-full text-xs transition-colors hover:bg-[#ff6b35] hover:text-white ${
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {language === 'gu' ? 'આ પોસ્ટ શેર કરો' : language === 'hi' ? 'यह पोस्ट शेयर करें' : 'Share this post'}
                  </Button>
