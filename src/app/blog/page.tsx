      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 py-24">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {loading ? (
              <div className="flex flex-col divide-y" style={{ borderColor: theme === 'dark' ? 'rgba(255,107,53,0.1)' : 'rgba(0,0,0,0.07)' }}>
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="py-7 first:pt-0 animate-pulse">
                    <div className="flex flex-col sm:flex-row gap-5">
                      <div className="sm:w-44 md:w-52 h-36 bg-gray-200 dark:bg-gray-700 rounded-xl flex-shrink-0" />
